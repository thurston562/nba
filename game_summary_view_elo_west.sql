create or replace view game_sum_view_elo_west as
...
from game_summary where game_date > '2020-11-01' and visitor_team in (select team from nba_conference where conference = 'E') 
                                                 and home_team in (select team from nba_conference where conference = 'W')
